            ...
            <Row align='middle' justify='space-between' gutter={32}>
              ...
              >
                <h1 style={{ fontSize: '1.8rem' }}>
                  <span>
                    Wallet Address: {shortenAddress(props.currentWallet.id)}
                  </span>
                  &nbsp;
                  <span>
                    <Tooltip
                ...
                <h2>
                  ...
                  <Tag
                    ...
                    style={{ transform: 'scale(1.4)', position: 'relative', top: '-0.3em', lineHeight: '2em'}}
                  >
                    {props.currentWallet.risk}
                  </Tag>
                  &nbsp; &nbsp;
                  <Tooltip title={showRiskTriggered(props.currentWallet.riskTriggered)}>
                    <EyeOutlined style={{ cursor: 'pointer', transform: 'scale(0.8)' }} />
                  </Tooltip>
                </h2>
              </Col>
              <Col span={11} className='wallet-details-col'>
                ...
                <Table
                  ...
                  columns={[
                    ...
                    {
                      dataIndex: 'eth',
                      render: text => moneyToLocaleString(text) + ' ETH'
                    },
                    {
                      dataIndex: 'usd',
                      render: text => moneyToLocaleString(text) + ' USD'
                    },
                    {
                      dataIndex: 'num',
                      render: text => numberToTxn(text)
                    },
                  ]}
                  dataSource={[
                    {
                      ...
                      eth: convertToPrecision(
                        props.currentWallet.currentBalance,
                        CryptoPrecision
                      ),
                      usd: convertToPrecision(
                        props.currentWallet.ethPrice *
                          props.currentWallet.currentBalance,
                        USDPrecision
                      )
                    },
                    {
                      ...
                      num: props.currentWallet.receivedTransactions
                    },
                    {
                      key: '3',
                      name: styledField('Total Sent:'),
                      eth: convertToPrecision(
                        props.currentWallet.sent,
                        CryptoPrecision
                      ),
                      usd: convertToPrecision(
                        props.currentWallet.ethPrice * props.currentWallet.sent,
                        USDPrecision
                      ),
                      num: props.currentWallet.sentTransactions
                    },
                  ]}
                  size='middle'
                  pagination={false}
              ...
              <Col span={11} className='wallet-details-col'>
                ...
                <Table
                  ...
                  dataSource={[
                    {
                      key: '1',
                      1: styledField('Entity:'),
                      2: props.currentWallet.customer
                    },
                    {
                      key: '2',
                      1: styledField('Wallet Creation:'),
                      2: formatDate(props.currentWallet.createdAt),
                      3: styledField('Last Activity:'),
                      4: formatDate(props.currentWallet.lastActivityTime)
                    },
                    {
                      key: '3',
                      1: styledField('Last Screened:'),
                      2: formatDate(props.currentWallet.lastScreenedTime),
                      3: styledField('Screened By:'),
